...
public final class Constants {
    ...
    public static final int NQT_BLOCK = 1;
    ...
    public static final int VOTING_SYSTEM_BLOCK = 2;
    public static final int PHASING_BLOCK = 2;

    public static final int LAST_KNOWN_BLOCK = 0;

    public static final int[] MIN_VERSION = {1, 2};
